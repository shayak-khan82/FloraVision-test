      ...
      <div className="relative">
          ...
          <div className="relative max-w-7xl w-full mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 items-center z-10">
            ...
            <div className="lg:col-span-7 flex flex-col items-start gap-8">
              ...
              <div className="flex items-center gap-6 mt-2">
                ...
                <button className="flex items-center gap-3.5 text-white hover:text-[#a3e635] font-medium transition-colors group cursor-pointer text-[15px] tracking-wide bg-transparent border-none">
                  <div className="w-12 h-12 rounded-full border border-white flex items-center justify-center bg-white/5 backdrop-blur-sm group-hover:border-[#a3e635] group-hover:bg-[#a3e635]/10 transition-all">
                    <Play className="w-4 h-4 fill-white text-white group-hover:fill-[#a3e635] group-hover:text-[#a3e635] translate-x-[1px]" />
                  </div>
                  Live Demo...
              ...
              <div className="bg-white/5 backdrop-blur-md rounded-[24px] p-6 max-w-[380px] mt-12 border border-white/10 shadow-2xl relative overflow-hidden">
                <div className="flex items-center gap-4">
                  ...
                  />
                  <div>
                    <h4 className="font-sans font-semibold text-white text-base">Ronnie Hamill</h4>
                    <div className="flex items-center gap-0.5 mt-0.5 text-[#eab308]">
                      {[...Array(4)].map((_, i) => (
                        <Star key={i} className="w-3.5 h-3.5 fill-current" />
                      ))}
              ...
              <div className="bg-white/[0.04] backdrop-blur-xl rounded-[90px_75px_45px_45px] p-8 pb-10 w-full max-w-[440px] h-[640px] border border-white/[0.12] shadow-[0_25px_60px_-15px_rgba(0,0,0,0.7)] relative flex flex-col justify-between overflow-visible">
                ...
                <div className="relative w-full flex items-center justify-center -mt-20 overflow-visible">
                  <img 
                    src="/images/image-2.png" 
                    alt="Aglaonema plant" 
                    className="w-auto h-[380px] object-contain drop-shadow-[0_25px_35px_rgba(0,0,0,0.65)] transform hover:scale-[1.02] transition-transform duration-500 select-none z-10"
                  />
                </div>

                <div className="mt-auto px-2 flex flex-col gap-2">
                  <span className="text-gray-300/70 text-[15px] font-light tracking-wide">Indoor Plant</span>
                  
                  <div className="flex items-center justify-between gap-4">
                    <h3 className="font-sans font-normal text-[34px] text-white tracking-wide leading-tight">
                      Aglaonema plant
                    </h3>
                    <button className="text-white opacity-80 hover:opacity-100 transition-opacity p-1 cursor-pointer bg-transparent border-none">
                      <ChevronRight className="w-8 h-8 stroke-[1.25]" />
                    </button>
                  </div>
                </div>

                <div className="mt-6 px-2 flex flex-col gap-6">
                  <div>
                    <button className="w-full border-2 border-white/80 hover:border-white hover:bg-white/5 text-white font-normal py-3.5 rounded-[18px] transition-all text-lg tracking-wide bg-transparent cursor-pointer">
                      Buy Now
                    </button>
                  </div>

                  <div className="flex items-center justify-center gap-2.5 mt-2">
                    <span className="w-6 h-1.5 rounded-full bg-white opacity-90" />
        ...
        <section className="relative py-20 px-6 md:px-12 flex flex-col items-center z-10 bg-[#171E13]/50">
          <div className="max-w-7xl w-full mx-auto">
            ...
            {/* Context Heading Brackets */}
            <div className="flex justify-center mb-32">
              <div className="relative inline-block">
                <span className="absolute -left-8 top-1/2 -translate-y-1/2 text-[#a3e635] text-4xl font-light opacity-60">[</span>
                <span className="absolute -right-8 top-1/2 -translate-y-1/2 text-[#a3e635] text-4xl font-light opacity-60">]</span>
                <h2 className="font-sans font-medium text-lg md:text-xl tracking-widest text-white uppercase px-6">
                  Our Trendy plants
                </h2>
              </div>
            </div>
            ...
            <div className="flex flex-col gap-28 w-full">
              ...
              <div className="bg-white/5 backdrop-blur-md rounded-[40px] p-8 md:p-12 md:pl-0 border border-white/10 shadow-2xl relative">
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
                  <div className="lg:col-span-5 flex justify-center relative lg:static">
                    <div className="relative w-64 h-64 md:w-80 md:h-80 lg:absolute lg:left-8 lg:-top-16 lg:bottom-8 lg:w-[420px] lg:h-[400px] flex items-center justify-center pointer-events-none">
                      <img src="/images/image-2.png" alt="Desk Item Layout 1" className="w-full h-full object-contain filter drop-shadow-[0_15px_25px_rgba(0,0,0,0.5)]" />
                    </div>
                    <div className="hidden lg:block lg:w-[350px] lg:h-[280px]" />
                  </div>
                  
                  <div className="lg:col-span-7 flex flex-col items-start gap-5 lg:pl-8">
                    <h3 className="text-white text-2xl md:text-4xl font-normal tracking-wide">For Your Desks Decorations</h3>
                    <p className="text-gray-300 font-light text-base md:text-[17px] max-w-xl leading-relaxed">
                      I recently added a beautiful desk decoration plant to my workspace, and it has made such a positive difference!
                    </p>
                    <p className="text-[#eff0ed] text-2xl font-medium tracking-wide mt-2">Rs. 599/-</p>
                    <button className="flex items-center gap-2.5 border border-white/30 hover:border-white text-white hover:bg-white/5 px-8 py-3 rounded-xl transition-all cursor-pointer bg-transparent font-medium tracking-wide text-sm">
              ...
              <div className="bg-white/5 backdrop-blur-md rounded-[40px] p-8 md:p-12 md:pr-0 border border-white/10 shadow-2xl relative">
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
                  <div className="lg:col-span-7 flex flex-col items-start gap-5 order-2 lg:order-1 lg:pr-8">
                    ...
                    <p className="text-[#eff0ed] text-2xl font-medium tracking-wide mt-2">Rs. 399/-</p>
                    <button className="flex items-center gap-2.5 border border-white/30 hover:border-white text-white hover:bg-white/5 px-8 py-3 rounded-xl transition-all cursor-pointer bg-transparent font-medium tracking-wide text-sm">
                      <ShoppingBag className="w-4 h-4" />
                      Explore
                    </button>
                  ...
                  <div className="lg:col-span-5 flex justify-center relative lg:static order-1 lg:order-2">
                    <div className="relative w-64 h-64 md:w-80 md:h-80 lg:absolute lg:right-8 lg:-top-16 lg:bottom-8 lg:w-[420px] lg:h-[400px] flex items-center justify-center pointer-events-none">
                      <img src="/images/heroimage.png" alt="Desk Item Layout 2" className="w-full h-full object-contain filter drop-shadow-[0_15px_25px_rgba(0,0,0,0.5)]" />
                    </div>
                    <div className="hidden lg:block lg:w-[350px] lg:h-[280px]" />
                  </div>
                </div>
